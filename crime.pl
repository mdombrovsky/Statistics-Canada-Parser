...
my $graphFileOut = "Substance_and_Crime.pdf";
...
print "Price of alcohol, tobacco and marijuana vs the rate of crime for a certain province\n\nSelect year range from 1999 to 2017\n";
